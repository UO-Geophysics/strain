...
plt.scatter(dist[6:8],tau_array[6:8],label='M7.1')
plt.scatter(dist[0:2],tau_array[0:2],label='M6.4')
plt.scatter(dist[15:17],tau_array[15:17],label='M5.5')
plt.scatter(dist[9:11],tau_array[9:11],label='M5.5')
plt.scatter(dist[12:14],tau_array[12:14],label='M5.4')
plt.scatter(dist[3:5],tau_array[3:5],label='M5.4')
